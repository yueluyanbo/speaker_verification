...
class SpeakerNet_evaluate(nn.Module):

    def __init__(self, model, optimizer, scheduler, trainfunc, **kwargs):
        super(SpeakerNet_evaluate, self).__init__();
    ...
    def evaluateFromList(self, wav1, wav2, print_interval=100, test_path='', num_eval=10, eval_frames=None):
